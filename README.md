...
.pattern-bg {
	background: url(https://cdn.discordapp.com/attachments/774305142538895400/951216520955035729/cd4751344dffb2b8ee6ad2a31f2b3e7e.jpg) repeat !important;
...
/* Hub */
 #left-icons > div:nth-child(1) > div:nth-child(1) > div{
     content: url(https://cdn.discordapp.com/attachments/947597952220807251/949002745686417479/globe-12150.png) !important;
     width: 70px;
	
}
/* Store */
 #left-icons > div:nth-child(1) > div:nth-child(2) > div{
     content: url(https://cdn.discordapp.com/attachments/947597952220807251/949002432791330857/store-1068.png) !important;
     width: 70px;
}
/* Servers */
 #left-icons > div:nth-child(1) > div:nth-child(3) > div{
     content: url(https://cdn.discordapp.com/attachments/947597952220807251/949002454391992350/game-controller-1396.png) !important;
     width: 70px;
}
/* Map */
 #left-icons > div:nth-child(1) > div:nth-child(4) > div{
     content: url(https://cdn.discordapp.com/attachments/947597952220807251/949001621336104990/maps-location-11100.png) !important;
     width: 70px;
}
/* News */
 #left-icons > div:nth-child(2) > div{
     content: url(https://cdn.discordapp.com/attachments/947597952220807251/949001925511241788/news-4301_3.png) !important;
     width: 70px;
}
...
#logo {
  content: url(https://yt3.ggpht.com/75gELh7usdQoeYK01iu15Oe2IZ5FtowL65ndvP-h_TEi7gtcpQ_Ajha6F5fdvJrwkseY2NqU5gM=s900-c-k-c0x00ffffff-no-rj);
  width: 300px;
  height: 300px;
}
/*  BG GONE */
...
/* End Game Screen */
.end-modal {
	background: url(https://i.pinimg.com/originals/cd/47/51/cd4751344dffb2b8ee6ad2a31f2b3e7e.jpg) !important;
}
...
/*  INFO CSS   */
.play:before {
	content: "CSS modified by OnFire29 (Micropenia)";
	margin-right: 30px;
	-webkit-animation: glow 2s ease-in-out infinite alternate;
	-moz-animation: glow 2s ease-in-out infinite alternate;
	animation: glow 2s ease-in-out infinite alternate;
